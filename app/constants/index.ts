...
export const user = { name: "Emre" };

export const dashboardStats = {
  totalUsers: 12450,
  usersJoined: { currentMonth: 218, previousMonth: 200 },
  totalTrips: 3512,
  tripsCreated: { currentMonth: 98, previousMonth: 100 },
  userRole: { total: 52, currentMonth: 25, previousMonth: 15 },
};
...
export const users = [
  {
    ...
    createdDate: formatDate("2025-01-01"),
    itineraryCreated: 10,
    status: "user",
  },
  {
    ...
    imageUrl: "/assets/images/david.webp",
    createdDate: formatDate("2025-01-02"),
    itineraryCreated: 4,
    status: "user",
  },
  {
    ...
    imageUrl: "/assets/images/david.webp",
    createdDate: formatDate("2025-01-03"),
    itineraryCreated: 8,
    status: "admin",
  },
];
